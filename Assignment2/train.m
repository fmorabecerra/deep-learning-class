...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    %error% embed_to_hid_weights_gradient = back_propagated_deriv_1' * embedding_layer_state;
    ...
    %error% hid_bias_gradient = sum(back_propagated_deriv_1, 1);
    %error% hid_bias_gradient = back_propagated_deriv_1;
    %error% hid_bias_gradient = back_propagated_deriv_1';
    ...
    %error% back_propagated_deriv_2 = back_propagated_deriv_1 * embed_to_hid_weights;
    %error% back_propagated_deriv_2 = back_propagated_deriv_1' * embed_to_hid_weights;
    %error% back_propagated_deriv_2 = back_propagated_deriv_1 * embed_to_hid_weights';
...
% Pancho added this
model.final_trainset_CE = trainset_CE;
...
model.final_validation_CE = CE; %Pancho
if OctaveMode
  fflush(1);
end
